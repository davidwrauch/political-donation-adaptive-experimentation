...
def test_app_shell_uses_ballot_chase_positioning():
    ...
    for text in [
        ...
        "<strong>more than 25% improvement in expected stream rate</strong>",
        "<strong>13.62% higher engagement</strong>",
        "<strong>20.79% improvement",
...
def test_what_if_tab_is_reframed_for_turnout_priorities():
    ...
    for text in [
        ...
        "Race-priority choices are not free improvements.",
